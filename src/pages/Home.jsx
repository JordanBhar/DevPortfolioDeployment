...
const Home = () => {
  const handleDownloadResume = () => {
    const confirmDownload = window.confirm("You are about to download a file. Do you want to continue?");
    if (confirmDownload) {
          ...
          <div className="flex flex-col md:flex-row space-y-5 md:space-y-10 md:space-x-40">
            ...
            <div className={`${styles.containers} md:w-5/6 lg:w-4/8 space-y-5 md:space-y-10`}>
              ...
              <div className={`${styles.col} items-start space-y-5`}>
                {contactData.map((contact) => (
                  <div className={`${styles.row} gap-x-4`} key={contact.data}>
                    <object data={contact.icon} height="30" width="30" className={styles.icons}></object>
              ...
              <div className={`flex flex-col ss:flex-row  pt-[30px] ss:space-x-5 ss:justify-center sm:justify-start gap-y-5`}>
                {/* Button 1 */}
                <a className={stylesHome.aboutButtons} href="#" onClick={handleDownloadResume}>
