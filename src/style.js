const styles = {
  boxWidth:
    "xl:w-[2000px] lg:w-[1300px] md:w-[900px] sm:w-[560px] ss:w-[360px] xs:w-[280px] p:w-[220px] w-full self-center mx-auto",
...
export const stylesHome = {
  ...
  profileImg:
    "h-[12em] w-[12em] sm:h-[15em] sm:w-[15em] md:w-[20em] md:h-[20em]  lg:w-[25em] lg:h-[25em] shadow-2xl rounded-full border-2 object-cover",
};
